...
# start = input("What date do you want to play? Type in the form of YYYY-MM-DD X:XX A/PM. An example is 2021-08-31 6:00 PM\n")
# print(start)
# time1 = start.split(" ")
# print(time1)
# timeFinal = time1[-2] + " " + time1[-1]
currDate = "2021-09-06"
...
start = "2021-08-30 3:00 PM"
datePicker = "Monday, Aug 30th, 2021"
timeFinal = "3:00 PM"
duration = "60"
courtNumber = "5"
number = "4"
...
calUrl = "https://app.reservemycourt.com/clubs/CLB-299e4786f534461ea8b2dce22bbe1b46/fullCalendarReservations/" + currDate
cal = s.get(calUrl)
print(cal.text)
for x in cal.json():
